...
namespace Web.Infrastructure
{
    ...
    public class OrderService
    {
        ...
        public List<Order> GetOrdersForCompany(int requestedCompanyId)
        {
            ...
            var orderSQL =
                $@"SELECT o.order_id, o.description, c.company_id, c.name company_name, p.product_id, p.name product_name, p.price product_price, op.price order_item_price, op.quantity
                FROM[dbo].[Order] o
